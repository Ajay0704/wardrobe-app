...
const linkCls = "text-sm whitespace-nowrap transition-colors";
const loginCls =
  "text-sm whitespace-nowrap text-muted transition-colors hover:text-foreground";
const signupCls =
  "whitespace-nowrap rounded-lg bg-accent px-3 py-2 text-sm font-medium text-accent-foreground transition-opacity hover:opacity-90 sm:px-4";
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-line bg-background pt-[env(safe-area-inset-top)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)]">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
        <Link href="/" className="brand-wordmark shrink-0 leading-none">
